...
import 'package:amst_lab4/constants/colors.dart';
import 'package:amst_lab4/utils/info.dart';
...
class _ForYouView extends State<ForYouView> {
  ...
  Widget _carousel() {
    return CarouselSlider(
      ...
      items: [
        _carouselImage("asset/images/carousel1.jpg"),
        _carouselImage("asset/images/carousel2.jpg"),
        _carouselImage("asset/images/carousel3.jpg"),
      ],
    );
  }
